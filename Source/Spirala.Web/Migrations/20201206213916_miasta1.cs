...
{
    public partial class miasta1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MilitaryUnitId = table.Column<Guid>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Nazwa = table.Column<string>(nullable: true),
                    WojewodztwoID = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Powiat", x => x.ID);
                    table.ForeignKey(
                        name: "FK_Powiat_Wojewodztwo_WojewodztwoID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Nazwa = table.Column<string>(nullable: true),
                    WojewodztwoID = table.Column<int>(nullable: false),
                    PowiatID = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Miasto", x => x.ID);
                    table.ForeignKey(
                        name: "FK_Miasto_Powiat_PowiatID",
                        column: x => x.PowiatID,
                        principalTable: "Powiat",
                        principalColumn: "ID");
                    table.ForeignKey(
                        name: "FK_Miasto_Wojewodztwo_WojewodztwoID",
                        column: x => x.WojewodztwoID,
                        principalTable: "Wojewodztwo",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Miasto_PowiatID",
                table: "Miasto",
                column: "PowiatID");

            migrationBuilder.CreateIndex(
                name: "IX_Miasto_WojewodztwoID",
                table: "Miasto",
